...
|Hyperlink on home page (SEE MORE) |
On the homepage there is a hyperlink which is entitled "SEE MORE",when this linked is clicked on it will take you to the gallery page | result as expected link works | Link takes to the gallery page | No bug detected |
